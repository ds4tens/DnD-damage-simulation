...
const listOfCharactersDualSword = Array.from({length: 20}, (_, index) => new BaseCharacter(index + 1, barb, dualSword, 'strength', stats))
const listOfCharactersHeavySword = Array.from({length: 20}, (_, index) => new BaseCharacter(index + 1, barb, heavySword, 'strength', stats))
